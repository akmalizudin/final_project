...
class LoanFactory extends Factory
{
    ...
    {
        //associate loan with one member from members table
        $member = Member::find(fake()->numberBetween(1,50));
        //1. fake numberbetween -> generate random num
        //2. Member::find(xx) akan fetch row with the random number
        //3. $member variable is a member with id xx
